...
> **强制增强语义**：安装 gstack/superpower 后，增强能力在适用 Gate 阶段**强制使用**，不支持选择性关闭。详见 [增强层使用指南](../guides/enhancement-guide.md)。
>
...
- [PRD #003 — AgentDevFlow gstack/superpower 能力增强层接入](../prd/003_adf_enhancement_layer_2026-04-17.md)
