...
- [ ] `.claude/skills/adf-.claude/skills/adf-team-setup/SKILL.md` — 团队启动协议
- [ ] `skills/event-bus.md` — 事件总线语义
- [ ] `skills/adf-start-agent-team.md` — 团队启动 Skill
- [ ] `skills/adf-agent-bootstrap.md` — Agent 激活协议
...
- [ ] `.claude/skills/adf-qa-.claude/skills/adf-engineer/SKILL.md` — QA Engineer 角色定义
