---
name: adf-pmo-review
description: PMO 系统化地逐个解决 `docs/pmo/issues/` 下的 Open 问题：分析根因、与用户对齐方案、推动机制改进落地。
user-invocable: true
---
...
#### A. 阅读 `skills/shared/` 目录

**必须全部读完：**
- [ ] `skills/shared/skill-protocol.md` — 共享技能协议
- [ ] `.claude/skills/adf-team-setup/SKILL.md` — 团队启动协议
- [ ] `skills/shared/event-bus.md` — 事件总线语义
- [ ] `.claude/skills/adf-create-agent/SKILL.md` — Agent 创建规范
- [ ] `.claude/skills/adf-start-agent-team/SKILL.md` — 团队启动 Skill
- [ ] `.claude/skills/adf-agent-bootstrap/SKILL.md` — Agent 激活协议
- [ ] `.claude/skills/adf-agents/README.md` — Agent 角色索引
- [ ] `.claude/skills/adf-agents/pmo.md` — PMO 角色定义（必读）
- [ ] `.claude/skills/adf-agents/team-lead.md` — Team Lead 角色定义
- [ ] `.claude/skills/adf-agents/product-manager.md` — PM 角色定义
- [ ] `.claude/skills/adf-agents/architect.md` — Architect 角色定义
- [ ] `.claude/skills/adf-agents/qa-engineer.md` — QA Engineer 角色定义
- [ ] `.claude/skills/adf-agents/engineer.md` — Engineer 角色定义
