...
| 角色类型 | Skill 路径 |
|---------|-----------|
| `product-manager` | `.claude/skills/adf-adf-product-manager/SKILL.md` |
| `architect` | `.claude/skills/adf-adf-architect/SKILL.md` |
| `qa-engineer` | `.claude/skills/adf-adf-qa-engineer/SKILL.md` |
| `engineer` | `.claude/skills/adf-adf-engineer/SKILL.md` |
| `platform-sre` | `.claude/skills/adf-adf-platform-sre/SKILL.md` |
| `pmo` | `.claude/skills/adf-adf-pmo/SKILL.md` |
