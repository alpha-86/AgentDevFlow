...
- [ ] `skills/shared/team-setup.md` — 团队启动协议
- [ ] `skills/shared/event-bus.md` — 事件总线语义
- [ ] `skills/shared/create-agent.md` — Agent 创建规范
- [ ] `skills/shared/start-agent-team.md` — 团队启动 Skill
- [ ] `skills/shared/agent-bootstrap.md` — Agent 激活协议
- [ ] `.claude/skills/adf-adf-pmo/SKILL.md` — PMO 角色定义（必读）
- [ ] `.claude/skills/adf-adf-team-lead/SKILL.md` — Team Lead 角色定义
- [ ] `.claude/skills/adf-adf-product-manager/SKILL.md` — PM 角色定义
- [ ] `.claude/skills/adf-adf-architect/SKILL.md` — Architect 角色定义
- [ ] `.claude/skills/adf-adf-qa-engineer/SKILL.md` — QA Engineer 角色定义
- [ ] `.claude/skills/adf-adf-engineer/SKILL.md` — Engineer 角色定义
