...
- PRD：`skills/templates/prd-template.md`
...
1. PM 准备 PRD 和验收标准。
2. Architect 评估可行性、依赖和风险。
3. 必要时由领域 reviewer 验证业务匹配。
4. PM 和 Architect 在 PRD 评审 record 中记录签字结论。
5. 若当前 Issue 需要文档阶段 Human Review #1（对应文档 PR），执行人工评审。
