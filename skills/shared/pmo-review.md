...
- [ ] `skills/shared/agents/README.md` — Agent 角色索引
- [ ] `skills/shared/agents/pmo.md` — PMO 角色定义（必读）
- [ ] `skills/shared/agents/team-lead.md` — Team Lead 角色定义
- [ ] `skills/shared/agents/product-manager.md` — PM 角色定义
- [ ] `skills/shared/agents/architect.md` — Architect 角色定义
- [ ] `skills/shared/agents/qa-engineer.md` — QA Engineer 角色定义
- [ ] `skills/shared/agents/engineer.md` — Engineer 角色定义
